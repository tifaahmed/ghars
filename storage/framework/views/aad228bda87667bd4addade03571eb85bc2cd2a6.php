...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active <?php echo e($pull); ?>"><?php echo e(trans('admin.gift_add')); ?></li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans('admin.gift_add')); ?></h3>
        ...
        <form action="<?php echo e(URL::to('admin/gifts')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?php echo e(Form::select('type', ['childern'=>trans('admin.childern') , 'families'=>trans('admin.families') , 'teachers'=>trans('admin.teachers')], null, ['class'=>'form-control select2','id'=>'type'])); ?>
...
<?php echo $__env->make('admin.layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/admin/gifts/create.blade.php ENDPATH**/ ?>