...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active <?php echo e($pull); ?>"><?php echo e(trans('admin.family_add')); ?></li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans('admin.family_add')); ?></h3>
        ...
        <form action="<?php echo e(URL::to('admin/families/')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <?php echo e(Form::number('members_count', null, ['class'=>'form-control','id'=>'members_count'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <?php echo e(Form::text('ar_parent_status', null, ['class'=>'form-control','id'=>'ar_parent_status'])); ?>
                            ...
                            <div class="col-sm-4">
                                <?php echo e(Form::text('en_parent_status', null, ['class'=>'form-control','id'=>'en_parent_status'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <?php echo e(Form::number('males', null, ['class'=>'form-control','id'=>'males'])); ?>
                            ...
                            <div class="col-sm-4">
                                <?php echo e(Form::number('females', null, ['class'=>'form-control','id'=>'females'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php echo e(Form::text('responsible_civil_id', null, ['class'=>'form-control','id'=>'responsible_civil_id'])); ?>
...
<?php echo $__env->make('admin.layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/admin/families/create.blade.php ENDPATH**/ ?>