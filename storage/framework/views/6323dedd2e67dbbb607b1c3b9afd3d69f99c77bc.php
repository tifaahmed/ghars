                ...
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('teacher/'.$teacher['id'].'?type=info')); ?>" class="sideBar__link active_link">
                                ...
                                <div class="form__row">
                                    <div class="col-12 col-lg-4">
                                        <div class="childIN_thumb">
                                            <img src="<?php echo e(url('upload/teachers/'.$teacher['image'])); ?>" alt="<?php echo e($teacher[$lang.'_name']); ?>" class="childIMG_one">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-8">
                                        <div class="innerForm__row">
                                            <div class="col-12 col-lg-12">
                                                ...
                                                <input type="text" class="profileV__input" value="<?php echo e($teacher[$lang.'_name']); ?>" disabled="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="gender" class="profileV__label"><?php echo e(trans('admin.gender')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e(trans('admin.'.$teacher['gender'])); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="nationality" class="profileV__label"><?php echo e(trans('admin.nationality')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher[$lang.'_nationality']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="birth_date" class="profileV__label"><?php echo e(trans('admin.birth_date')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher['birth_date']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="country" class="profileV__label"><?php echo e(trans('admin.country')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher['Country'][$lang.'_name']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-8">
                                        <label for="address" class="profileV__label"><?php echo e(trans('admin.address')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher[$lang.'_address']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="social_status" class="profileV__label"><?php echo e(trans('admin.social_status')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher[$lang.'_status']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="phone" class="profileV__label"><?php echo e(trans('admin.phone')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher['phone']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="email" class="profileV__label"><?php echo e(trans('admin.email')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($teacher['email']); ?>" disabled="">
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/teacher_info.blade.php ENDPATH**/ ?>