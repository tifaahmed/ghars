            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('family/'.$family['id'].'?type=gift')); ?>" class="sideBar__link active_link">
                    ...
                    <div class="myInfo__taBorder">
                        <h3 class="myInfo_title row">
                            <div class="col-12 col-lg-6">
                                <?php echo e(trans('admin.family_gift')); ?>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/family_gifts.blade.php ENDPATH**/ ?>