...
// whether to hide the notification on click
    ...
    if ($('#orders_notify').val() > 0) {
        ...
        <!-- DataTables -->
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_components/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
        ...
        <!-- This is data table -->
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_plugins/DataTables-1.10.15/media/js/jquery.dataTables.min.js"></script>
        ...
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/dataTables.buttons.min.js"></script>
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.flash.min.js"></script>
        ...
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.html5.min.js"></script>
        <script src="<?php echo e(URL::to('admin_panel')); ?>/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.print.min.js"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/admin/layouts/table.blade.php ENDPATH**/ ?>