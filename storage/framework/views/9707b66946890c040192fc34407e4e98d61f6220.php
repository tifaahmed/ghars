            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('family/'.$family['id'].'?type=reports')); ?>" class="sideBar__link active_link">
                                ...
                                <table class="table reports__table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a style="color: #000;" href="<?php echo e(url('upload/families/'.$report['file'])); ?>" target="_balnk" class="printRepo_link"> <img src="<?php echo e(url('interface')); ?>/img/print.svg" alt="" class="printR_icon"><?php echo e(trans('admin.print')); ?></a> </td>
                                        </tr>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/family_reports.blade.php ENDPATH**/ ?>