            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('child/'.$child['id'].'?type=study')); ?>" class="sideBar__link active_link">
                    ...
                    <div class="myInfo__taBorder">
                        <h3 class="myInfo_title row">
                            <div class="col-12 col-lg-6">
                                <?php echo e(trans('admin.sponsorship_study')); ?>
                            ...
                            <form action="" class="myProInfo__form">
                                <div class="form__row">
                                    <div class="col-12 col-lg-4">
                                        <label for="study_stage" class="profileV__label"><?php echo e(trans('admin.study_stage')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_study_stage']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="class" class="profileV__label"><?php echo e(trans('admin.class')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_class']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="quran" class="profileV__label"><?php echo e(trans('admin.quran')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_quran']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-12">
                                        <label for="skills" class="profileV__label"><?php echo e(trans('admin.skills')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_skills']); ?>" disabled="">
                                    </div>
                                
                                    <?php if($child['study_report'] != ''): ?>
                                    <a href="<?php echo e(url('upload/childern/'.$child['study_report'])); ?>" target="_blank" class="contSubmit__btn subMidBtn_width"><?php echo e(trans('admin.study_report')); ?></a>
                                    <?php endif; ?>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/child_study.blade.php ENDPATH**/ ?>