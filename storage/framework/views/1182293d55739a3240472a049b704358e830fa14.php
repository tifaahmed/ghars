...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active <?php echo e($pull); ?>"><?php echo e(trans('admin.tutorial_add')); ?></li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans('admin.tutorial_add')); ?></h3>
        ...
        <form action="<?php echo e(URL::to('admin/tutorials')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo e(Form::textarea('ar_desc', null, ['class'=>'form-control','id'=>'ar_desc'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo e(Form::textarea('en_desc', null, ['class'=>'form-control','id'=>'en_desc'])); ?>
...
<?php echo $__env->make('admin.layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/admin/tutorials/create.blade.php ENDPATH**/ ?>