    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">         
                <form action="<?php echo e(url('donation/families/'.$family['id'])); ?>" method="post" class="loginV__form">
                    <?php echo e(csrf_field()); ?>

                    <?php echo e(Form::hidden('pay_type','knet',['id'=>'pay_type'])); ?>


                    <h3 class="loginModal_title"><?php echo e(trans('admin.donate')); ?> : <?php echo e($family[$lang.'_name']); ?></h3>
                    <p class="logintModal_des"><?php echo e(number_format($family['amount'] / $currency_info['equal'], $currency_info['currency_format'], '.', '') . ' ' . $currency_info[$lang . '_currency']); ?></p>
                    <div class="form__row">
                        <?php if(!Auth::Check()): ?>
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <?php echo e(Form::select('time',['more'=>trans('admin.more_time'),'one'=>trans('admin.one_time')], null, ['class'=>'loginV__input nice-select','id'=>'time','required'])); ?>
...
<div class="modal loginModal fade" id="giftModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <img src="<?php echo e(url('interface')); ?>/img/si.png" alt="" class="check__thumb">
            <div class="modal-body">         
                <form action="<?php echo e(url('gift/families/'.$family['id'])); ?>" method="post" class="loginV__form">
                    <?php echo e(csrf_field()); ?>

                    <?php echo e(Form::hidden('gift_id',null,['id'=>'gift_id'])); ?>


                    <h3 class="loginModal_title"><?php echo e(trans('admin.family_gift')); ?></h3>
                    <p class="logintModal_des"><?php echo e($family[$lang.'_name']); ?></p>
                    <div class="form__row">
                        <div class="col-12 col-lg-6">
                    ...
                    <button class="login__btn" type='submiut'><?php echo e(trans('admin.family_gift')); ?></button>
                </form>
            </div>
        </div>
    </div>
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/family_modal.blade.php ENDPATH**/ ?>