            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('child/'.$child['id'].'?type=social')); ?>" class="sideBar__link active_link">
                                <img src="<?php echo e(url('interface')); ?>/img/archive-book.png" alt="" class="profileTH_icon">
                            ...
                            <form action="" class="myProInfo__form">
                                <div class="form__row">
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <input type="text" class="profileV__input" value="<?php echo e($child['death_date']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="death_reason" class="profileV__label"><?php echo e(trans('admin.death_reason')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_death_reason']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="responsible" class="profileV__label"><?php echo e(trans('admin.responsible')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_responsible']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="relative" class="profileV__label"><?php echo e(trans('admin.relative')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_relative']); ?>" disabled="">
                                    </div>    
                                    <div class="col-12 col-lg-4">
                                        <label for="brothers" class="profileV__label"><?php echo e(trans('admin.brothers')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child['brothers']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="sisters" class="profileV__label"><?php echo e(trans('admin.sisters')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child['sisters']); ?>" disabled="">
                                    </div>                                
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/child_social.blade.php ENDPATH**/ ?>