...
<?php echo e(trans('admin.idea_desc')); ?>
...
<section class="innerTop_section"> 
    <div class="container pxLG-0">
        <h3 class="innerTop__title"><?php echo e(trans('admin.idea_desc')); ?></h3>
    </div>
</section>
    ...
    <div class="container pxLG-0">
        <div class="row">
            <div class="col-12 col-lg-6">
                <form class="contact__form" action="<?php echo e(url('idea')); ?>" method="post">
                    ...
                    <div class="form__row">
                        ...
                        <div class="col-12 col-lg-12">
                            <label class="login__label"><?php echo e(trans('admin.type')); ?></label>
                            <?php echo e(Form::select('type',['marketing'=>trans('admin.marketing') , 'voluntary'=>trans('admin.voluntary') , 'initiatives'=>trans('admin.initiatives') , 'helps'=>trans('admin.helps') , 'advertising'=>trans('admin.advertising') , 'events'=>trans('admin.events') , 'seminars'=>trans('admin.seminars') , 'messages'=>trans('admin.messages') , 'endowment'=>trans('admin.endowment')], null, ['class'=>'loginV__input','id'=>'type'])); ?>
                        ...
                        <div class="col-12 col-lg-12">
                            <label class="login__label"><?php echo e(trans('admin.ideas')); ?></label>
                            <?php echo e(Form::textarea('message', null, ['class'=>'loginV__input','id'=>'message', 'placeholder'=>trans('admin.ideas')])); ?>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/idea.blade.php ENDPATH**/ ?>