            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('child/'.$child['id'].'?type=health')); ?>" class="sideBar__link active_link">
                                <img src="<?php echo e(url('interface')); ?>/img/archive-book.png" alt="" class="profileTH_icon">
                    ...
                    <div class="myInfo__taBorder">
                        <h3 class="myInfo_title row">
                            <div class="col-12 col-lg-6">
                                <?php echo e(trans('admin.sponsorship_health')); ?>
                            ...
                            <form action="" class="myProInfo__form">
                                <div class="form__row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_psychological']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="healthy" class="profileV__label"><?php echo e(trans('admin.healthy')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_healthy']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="illness" class="profileV__label"><?php echo e(trans('admin.illness')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_illness']); ?>" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="illness_desc" class="profileV__label"><?php echo e(trans('admin.illness_desc')); ?></label>
                                        <input type="text" class="profileV__input" value="<?php echo e($child[$lang.'_illness_desc']); ?>" disabled="">
                                    </div>                                
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/child_health.blade.php ENDPATH**/ ?>