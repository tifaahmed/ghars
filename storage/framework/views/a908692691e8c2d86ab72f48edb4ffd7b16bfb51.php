...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active <?php echo e($pull); ?>"><?php echo e(trans('admin.gifts')); ?></li>
    </ol>
</section>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo e(URL::to('admin/gifts/create')); ?>" class="btn btn-lg bg-black"><?php echo e(trans('admin.gift_add')); ?></a>
                ...
                <div class="box-body">
                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle;"><?php echo e(trans('admin.'.$gift['type'])); ?></td>
                                <td style="vertical-align: middle;"><?php echo e($gift[$lang.'_name']); ?></td>
                                <td style="vertical-align: middle;"><?php echo e($gift['amount'].' '.trans('admin.kwd')); ?></td>
                                <td style="vertical-align: middle;">
                                    <label class="switch" style="margin-bottom: 0;">
                                        <?php if($gift['active'] == 'yes'): ?>
                                        <input class="switch_active" page='gifts' id="<?php echo e($gift['id']); ?>" type="checkbox" checked="">
                                        <?php else: ?>
                                        <input class="switch_active" page='gifts' id="<?php echo e($gift['id']); ?>" type="checkbox">
                                        <?php endif; ?>
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td style="vertical-align: middle;">
                                    <?php echo e(Form::open(array('url' =>'admin/gifts/'.$gift->id.'/edit', 'method' => 'GET'))); ?>
                                ...
                                <td style="vertical-align: middle;">
                                    <button type="button" class="btn default btn-sm bg-red" data-toggle="modal" data-target="#exampleModal<?php echo e($gift['id']); ?>"><i class="fa fa-trash-o"></i> <?php echo e(trans('admin.delete')); ?> </button>

                                    <div class="modal modal-danger fade" id="exampleModal<?php echo e($gift['id']); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <?php echo e(Form::open(array('url' =>'admin/gifts/'.$gift->id, 'method' => 'DELETE'))); ?>
...
<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <?php echo e(Form::open(array('url' =>'admin/delete_all/gifts', 'method' => 'POST'))); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <select id="ids" name="ids[]" class="form-control select2" multiple="multiple" data-placeholder="<?php echo e(trans('admin.delete_all')); ?>" style="width: 100%;" required="">
                    <?php $__currentLoopData = $gifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/admin/gifts/index.blade.php ENDPATH**/ ?>