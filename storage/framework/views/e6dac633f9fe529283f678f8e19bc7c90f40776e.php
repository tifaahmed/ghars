            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="<?php echo e(url('teacher/'.$teacher['id'].'?type=video')); ?>" class="sideBar__link active_link">
                                <img src="<?php echo e(url('interface')); ?>/img/archive-book.png" alt="" class="profileTH_icon">
                    ...
                    <div class="myInfo__taBorder">
                        ...
                        <div class="myINForm__Wrapz">
                            <div class="row guarantee__inRow">
                                ...
                                <div class="col-12 col-lg-6">
                                    <a href="<?php echo e($video['link']); ?>" target="_blank" class="spechVid__card">
                                        <div class="spechVid_thumb">
                                            <img src="<?php echo e(url('upload/teachers_videos/' . $video['image'])); ?>" alt="<?php echo e($video[$lang.'_name']); ?>" class="spechVid_img">
                                        </div>
                                        <h5 class="spechVid__name"><?php echo e($video[$lang.'_name']); ?></h5>
                                    </a>
                                </div>
...
<?php echo $__env->make('interface.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Sites/ghars/resources/views/interface/teacher_videos.blade.php ENDPATH**/ ?>