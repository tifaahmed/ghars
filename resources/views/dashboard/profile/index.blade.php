...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <form action="{{URL::to('dashboard/profile/'.Auth::User()->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('governate', Auth::User()->governate, ['class'=>'form-control','id'=>'governate']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('city', Auth::User()->city, ['class'=>'form-control','id'=>'city']) }}
                                @if($errors->has('city'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('street', Auth::User()->street, ['class'=>'form-control','id'=>'street']) }}
            ...
            <div class="box-footer">
                ...
                <a href="{{URL::to('dashboard')}}" class="btn btn-default btn-lg" style="font-size: 16px;">{{trans('admin.back')}}</a>
            </div>
