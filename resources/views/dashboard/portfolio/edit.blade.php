...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('dashboard/portfolio')}}"> {{trans('admin.portfolio')}}</a></li>
...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <form action="{{URL::to('dashboard/portfolio/'.$portfolio->id)}}" method="post" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class='col-md-4 {{$pull}}'>
                                    ...
                                    <a href="{{URL::to('dashboard/portfolio/'.$image['id'])}}" class="btn btn-block btn-danger"><span class="fa fa-trash-o"></span> {{trans('admin.delete')}}</a>
                                </div>
                                @endforeach
                            </div>
                        </div>
            ...
            <div class="box-footer">
                ...
                <a href="{{URL::to('dashboard/portfolio')}}" class="btn btn-default btn-lg" style="font-size: 16px;">{{trans('admin.back')}}</a>
            </div>
