            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="{{url('family/'.$family['id'].'?type=reports')}}" class="sideBar__link active_link">
                                ...
                                <table class="table reports__table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a style="color: #000;" href="{{url('upload/families/'.$report['file'])}}" target="_balnk" class="printRepo_link"> <img src="{{url('interface')}}/img/print.svg" alt="" class="printR_icon">{{trans('admin.print')}}</a> </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
