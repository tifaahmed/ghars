            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="{{url('family/'.$family['id'].'?type=member')}}" class="sideBar__link active_link">
                                <img src="{{url('interface')}}/img/archive-book.png" alt="" class="profileTH_icon">
                                ...
                                <div class="form__row">
                                    <div class="col-12 col-lg-4">
                                        <div class="childIN_thumb">
                                            <img src="{{url('upload/families_members/'.$member['image'])}}" alt="{{$member[$lang.'_name']}}" class="childIMG_one">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-8">
                                        ...
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_name']}}" disabled="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="birth_date" class="profileV__label">{{trans('admin.birth_date')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member['birth_date']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="gender" class="profileV__label">{{trans('admin.gender')}}</label>
                                        <input type="text" class="profileV__input" value="{{trans('admin.'.$member['gender'])}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="civil_id_type" class="profileV__label">{{trans('admin.civil_id_type')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_civil_id_type']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="civil_id" class="profileV__label">{{trans('admin.civil_id')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member['civil_id']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="career_status" class="profileV__label">{{trans('admin.career_status')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_career_status']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="class" class="profileV__label">{{trans('admin.class')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_class']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="healthy" class="profileV__label">{{trans('admin.healthy')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_healthy']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="psychological" class="profileV__label">{{trans('admin.psychological')}}</label>
                                        <input type="text" class="profileV__input" value="{{$member[$lang.'_psychological']}}" disabled="">
                                    </div>
                                </div>
                            </form>
                        </div>
