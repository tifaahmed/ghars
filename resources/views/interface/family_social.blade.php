            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="{{url('family/'.$family['id'].'?type=social')}}" class="sideBar__link active_link">
                            ...
                            <form action="" class="myProInfo__form">
                                <div class="form__row">
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <input type="text" class="profileV__input" value="{{$family[$lang.'_responsible']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="relative" class="profileV__label">{{trans('admin.relative')}}</label>
                                        <input type="text" class="profileV__input" value="{{$family[$lang.'_relative']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="responsible_civil_id" class="profileV__label">{{trans('admin.responsible_civil_id')}}</label>
                                        <input type="text" class="profileV__input" value="{{$family['responsible_civil_id']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-4">
                                        <label for="career_status" class="profileV__label">{{trans('admin.career_status')}}</label>
                                        <input type="text" class="profileV__input" value="{{$family[$lang.'_career_status']}}" disabled="">
                                    </div>    
                                    <div class="col-12 col-lg-4">
                                        <label for="career" class="profileV__label">{{trans('admin.career')}}</label>
                                        <input type="text" class="profileV__input" value="{{$family[$lang.'_career']}}" disabled="">
                                    </div>                              
                                </div>
                            </form>
                        </div>
