    ...
    <div class="container pxLG-0">
        <div class="searchResults__wrap">
            <div class="row guarantee__inRow">
                ...
                <?php $donation = \App\Models\Donation::where('user_id', Auth::User()->id)->where('user_type', 'user')->where('rel_id', $family['id'])->where('category', 'families')->where('gift_id', 0)->orderBy('id', 'desc')->first(); ?>
