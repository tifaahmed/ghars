            ...
            <div class="col-12 col-md-5 col-lg-3">
                <div class="sideBar__menu">
                    <ul class="sideBar__list">
                        ...
                        <li class="sideBar__item"> 
                            <a href="{{url('child/'.$child['id'].'?type=health')}}" class="sideBar__link active_link">
                                <img src="{{url('interface')}}/img/archive-book.png" alt="" class="profileTH_icon">
                    ...
                    <div class="myInfo__taBorder">
                        <h3 class="myInfo_title row">
                            <div class="col-12 col-lg-6">
                                {{trans('admin.sponsorship_health')}}
                            </div>
                            <div class="col-12 col-lg-6">
                            ...
                            <form action="" class="myProInfo__form">
                                <div class="form__row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="text" class="profileV__input" value="{{$child[$lang.'_psychological']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="healthy" class="profileV__label">{{trans('admin.healthy')}}</label>
                                        <input type="text" class="profileV__input" value="{{$child[$lang.'_healthy']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="illness" class="profileV__label">{{trans('admin.illness')}}</label>
                                        <input type="text" class="profileV__input" value="{{$child[$lang.'_illness']}}" disabled="">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="illness_desc" class="profileV__label">{{trans('admin.illness_desc')}}</label>
                                        <input type="text" class="profileV__input" value="{{$child[$lang.'_illness_desc']}}" disabled="">
                                    </div>                                
                                </div>
                            </form>
                        </div>
