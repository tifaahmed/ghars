...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.gifts')}}</li>
    </ol>
</section>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{URL::to('admin/gifts/create')}}" class="btn btn-lg bg-black">{{trans('admin.gift_add')}}</a>
                    ...
                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        <thead>
                            <tr> 
                                ...
                                <th class="{{$text}}">{{trans('admin.gift')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle;">{{trans('admin.'.$gift['type'])}}</td>
                                <td style="vertical-align: middle;">{{$gift[$lang.'_name']}}</td>
                                <td style="vertical-align: middle;">{{$gift['amount'].' '.trans('admin.kwd')}}</td>
                                <td style="vertical-align: middle;">
                                    <label class="switch" style="margin-bottom: 0;">
                                        @if($gift['active'] == 'yes')
                                        <input class="switch_active" page='gifts' id="{{$gift['id']}}" type="checkbox" checked="">
                                        @else
                                        <input class="switch_active" page='gifts' id="{{$gift['id']}}" type="checkbox">
                                        @endif
                                        <span class="slider"></span>
                                    </label>
                                </td>
                                <td style="vertical-align: middle;">
                                    {{ Form::open(array('url' =>'admin/gifts/'.$gift->id.'/edit', 'method' => 'GET')) }}
                                    <button  type="submit" class="btn default btn-sm btn-success"><i class="fa fa-edit"></i> {{trans('admin.edit')}} </button>
                                    {{ Form::close() }}
                                </td>
                                <td style="vertical-align: middle;">
                                    <button type="button" class="btn default btn-sm bg-red" data-toggle="modal" data-target="#exampleModal{{$gift['id']}}"><i class="fa fa-trash-o"></i> {{trans('admin.delete')}} </button>

                                    <div class="modal modal-danger fade" id="exampleModal{{$gift['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    {{ Form::open(array('url' =>'admin/gifts/'.$gift->id, 'method' => 'DELETE')) }}
...
<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        {{ Form::open(array('url' =>'admin/delete_all/gifts', 'method' => 'POST')) }}
        <div class="modal-content">
            <div class="modal-header">
