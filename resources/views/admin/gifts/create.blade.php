...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.gift_add')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.gift_add')}}</h3>
        ...
        <form action="{{URL::to('admin/gifts')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::select('type', ['childern'=>trans('admin.childern') , 'families'=>trans('admin.families') , 'teachers'=>trans('admin.teachers')], null, ['class'=>'form-control select2','id'=>'type']) }}
                                @if($errors->has('type'))
