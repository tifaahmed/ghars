...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('admin/families_members/'.$family['id'])}}"> {{trans('admin.members')}}</a></li>
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.family_member_add')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.family_member_add')}}</h3>
        ...
        <form action="{{URL::to('admin/families_members/')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_civil_type', null, ['class'=>'form-control','id'=>'ar_civil_type']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_civil_type', null, ['class'=>'form-control','id'=>'en_civil_type']) }}
            ...
            <div class="box-footer">
                ...
                <a href="{{URL::to('admin/families_members/'.$family['id'])}}" class="btn btn-default btn-lg" style="font-size: 16px;">{{trans('admin.back')}}</a>
            </div>
