                        ...
                        <div class="form-group row">
                            <table class="table table-bordered table-hover text-center">
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'currencies_all',$currencies_all,['id'=>'currencies_all','class'=>'check_currencies']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'currencies_edit',$currencies_edit,['id'=>'currencies_edit','class'=>'check_currencies']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'countries_all',$countries_all,['id'=>'countries_all','class'=>'check_countries']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'countries_edit',$countries_edit,['id'=>'countries_edit','class'=>'check_countries']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'notifications_all',$notifications_all,['id'=>'notifications_all','class'=>'check_notifications']) }}
                                            <label for="notifications_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'notifications_add',$notifications_add,['id'=>'notifications_add','class'=>'check_notifications']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'visitors_all',$visitors_all,['id'=>'visitors_all','class'=>'check_visitors']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'companies_all',$companies_all,['id'=>'companies_all','class'=>'check_companies']) }}
                                            <label for="companies_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'companies_add',$companies_add,['id'=>'companies_add','class'=>'check_companies']) }}
                                            <label for="companies_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'companies_edit',$companies_edit,['id'=>'companies_edit','class'=>'check_companies']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'portfolio_all',$portfolio_all,['id'=>'portfolio_all','class'=>'check_portfolio']) }}
                                            <label for="portfolio_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'portfolio_add',$portfolio_add,['id'=>'portfolio_add','class'=>'check_portfolio']) }}
                                            <label for="portfolio_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'portfolio_edit',$portfolio_edit,['id'=>'portfolio_edit','class'=>'check_portfolio']) }}
                                            <label for="portfolio_edit" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'portfolio_show',$portfolio_show,['id'=>'portfolio_show','class'=>'check_portfolio']) }}
                                            <label for="portfolio_show" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'portfolio_delete',$portfolio_delete,['id'=>'portfolio_delete','class'=>'check_portfolio']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ideas_all',$ideas_all,['id'=>'ideas_all','class'=>'check_ideas']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ideas_edit',$ideas_edit,['id'=>'ideas_edit','class'=>'check_ideas']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'categories_all',$categories_all,['id'=>'categories_all','class'=>'check_categories']) }}
                                            <label for="categories_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'categories_add',$categories_add,['id'=>'categories_add','class'=>'check_categories']) }}
                                            <label for="categories_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'categories_edit',$categories_edit,['id'=>'categories_edit','class'=>'check_categories']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'categories_delete',$categories_delete,['id'=>'categories_delete','class'=>'check_categories']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'projects_all',$projects_all,['id'=>'projects_all','class'=>'check_projects']) }}
                                            <label for="projects_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'projects_add',$projects_add,['id'=>'projects_add','class'=>'check_projects']) }}
                                            <label for="projects_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'projects_edit',$projects_edit,['id'=>'projects_edit','class'=>'check_projects']) }}
                                            <label for="projects_edit" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'projects_show',$projects_show,['id'=>'projects_show','class'=>'check_projects']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'gifts_all',$gifts_all,['id'=>'gifts_all','class'=>'check_gifts']) }}
                                            <label for="gifts_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'gifts_add',$gifts_add,['id'=>'gifts_add','class'=>'check_gifts']) }}
                                            <label for="gifts_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'gifts_edit',$gifts_edit,['id'=>'gifts_edit','class'=>'check_gifts']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'gifts_delete',$gifts_delete,['id'=>'gifts_delete','class'=>'gifts_delete']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'childern_all',$childern_all,['id'=>'childern_all','class'=>'check_childern']) }}
                                            <label for="childern_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'childern_add',$childern_add,['id'=>'childern_add','class'=>'check_childern']) }}
                                            <label for="childern_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'childern_edit',$childern_edit,['id'=>'childern_edit','class'=>'check_childern']) }}
                                            <label for="childern_edit" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'childern_show',$childern_show,['id'=>'childern_show','class'=>'check_childern']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'families_all',$families_all,['id'=>'families_all','class'=>'check_families']) }}
                                            <label for="families_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'families_add',$families_add,['id'=>'families_add','class'=>'check_families']) }}
                                            <label for="families_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'families_edit',$families_edit,['id'=>'families_edit','class'=>'check_families']) }}
                                            <label for="families_edit" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'families_show',$families_show,['id'=>'families_show','class'=>'check_families']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'teachers_all',$teachers_all,['id'=>'teachers_all','class'=>'check_teachers']) }}
                                            <label for="teachers_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'teachers_add',$teachers_add,['id'=>'teachers_add','class'=>'check_teachers']) }}
                                            <label for="teachers_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'teachers_edit',$teachers_edit,['id'=>'teachers_edit','class'=>'check_teachers']) }}
                                            <label for="teachers_edit" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'teachers_show',$teachers_show,['id'=>'teachers_show','class'=>'check_teachers']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'donations_all',$donations_all,['id'=>'donations_all','class'=>'check_donations']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'donations_edit',$donations_edit,['id'=>'donations_edit','class'=>'check_donations']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'tutorials_all',$tutorials_all,['id'=>'tutorials_all','class'=>'check_tutorials']) }}
                                            <label for="tutorials_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'tutorials_add',$tutorials_add,['id'=>'tutorials_add','class'=>'check_tutorials']) }}
                                            <label for="tutorials_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'tutorials_edit',$tutorials_edit,['id'=>'tutorials_edit','class'=>'check_tutorials']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'tutorials_delete',$tutorials_delete,['id'=>'tutorials_delete','class'=>'check_tutorials']) }}
                                ...
                                <tr class="pagetr">
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ads_all',$ads_all,['id'=>'ads_all','class'=>'check_ads']) }}
                                            <label for="ads_all" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ads_add',$ads_add,['id'=>'ads_add','class'=>'check_ads']) }}
                                            <label for="ads_add" style="height: 10px;"></label>
                                        </label> 
                                    </td>
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ads_edit',$ads_edit,['id'=>'ads_edit','class'=>'check_ads']) }}
                                    ...
                                    <td>
                                        <label class="m-checkbox m-checkbox--check-bold m-checkbox--state-primary">
                                            {{ Form::checkbox('permissions[]', 'ads_delete',$ads_delete,['id'=>'ads_delete','class'=>'check_ads']) }}
