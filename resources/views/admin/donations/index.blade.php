                ...
                <div class="box-body">
                    <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                        <thead>
                            <tr>
                                <th class="{{$text}}">#</th>
                                <th class="{{$text}}">{{trans('admin.department')}}</th>
                                <th class="{{$text}}">{{trans('admin.donate_for')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: middle;">{{$donation['id']}}</td>
                                <td style="vertical-align: middle;">{{trans('admin.'.$donation['category'])}}</td>
                                ...
                                <td style="vertical-align: middle;">{{trans('admin.'.$donation['type'].'_time')}}</td>
