                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                {{ Form::number('sort', $slider['sort'], ['class'=>'form-control','id'=>'sort']) }}
                                @if($errors->has('sort'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                {{ Form::text('ar_desc', $slider['ar_desc'], ['class'=>'form-control','id'=>'ar_desc']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                {{ Form::text('en_desc', $slider['en_desc'], ['class'=>'form-control','id'=>'en_desc']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <img src="{{URL::to('upload/slider/'.$slider['image'])}}" class="img-thumbnail image_current">
                            </div>
                        </div>
