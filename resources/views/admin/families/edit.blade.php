...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active {{$pull}}">{{trans('admin.family_edit')}}</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('admin.family_edit')}} : {{$family[$lang.'_name']}}</h3>
        ...
        <form action="{{URL::to('admin/families/'.$family['id'])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{ Form::select('active',['yes'=>trans('admin.approve_yes'),'no'=>trans('admin.approve_no')], $family['active'], ['class'=>'form-control select2','id'=>'active']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{ Form::select('country_id',$countries, $family['country_id'], ['class'=>'form-control select2','id'=>'country_id']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{ Form::select('gender',['male'=>trans('admin.male'),'female'=>trans('admin.female')], $family['gender'], ['class'=>'form-control select2','id'=>'gender']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::select('required',['no'=>trans('admin.no'),'yes'=>trans('admin.yes')], $family['required'], ['class'=>'form-control','id'=>'required']) }}
                            ...
                            <div class="col-sm-3">
                                {{ Form::text('amount', $family['amount'], ['class'=>'form-control','id'=>'amount']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_name', $family['ar_name'], ['class'=>'form-control','id'=>'ar_name']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_name', $family['en_name'], ['class'=>'form-control','id'=>'en_name']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_nationality', $family['ar_nationality'], ['class'=>'form-control','id'=>'ar_nationality']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_nationality', $family['en_nationality'], ['class'=>'form-control','id'=>'en_nationality']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('civil_id', $family['civil_id'], ['class'=>'form-control','id'=>'civil_id']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::number('members_count', $family['members_count'], ['class'=>'form-control','id'=>'members_count']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_parent_status', $family['ar_parent_status'], ['class'=>'form-control','id'=>'ar_parent_status']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_parent_status', $family['en_parent_status'], ['class'=>'form-control','id'=>'en_parent_status']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{ Form::text('death_date', $family['death_date'], ['class'=>'form-control','id'=>'death_date']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_death_reason', $family['ar_death_reason'], ['class'=>'form-control','id'=>'ar_death_reason']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_death_reason', $family['en_death_reason'], ['class'=>'form-control','id'=>'en_death_reason']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::number('males', $family['males'], ['class'=>'form-control','id'=>'males']) }}
                                @if($errors->has('males'))
                            ...
                            <div class="col-sm-4">
                                {{ Form::number('females', $family['females'], ['class'=>'form-control','id'=>'females']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_responsible', $family['ar_responsible'], ['class'=>'form-control','id'=>'ar_responsible']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_responsible', $family['en_responsible'], ['class'=>'form-control','id'=>'en_responsible']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_relative', $family['ar_relative'], ['class'=>'form-control','id'=>'ar_relative']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_relative', $family['en_relative'], ['class'=>'form-control','id'=>'en_relative']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('ar_career', $family['ar_career'], ['class'=>'form-control','id'=>'ar_career']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('en_career', $family['en_career'], ['class'=>'form-control','id'=>'en_career']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::textarea('ar_career_status', $family['ar_career_status'], ['class'=>'form-control','id'=>'ar_career_status']) }}
                            ...
                            <div class="col-sm-4">
                                {{ Form::textarea('en_career_status', $family['en_career_status'], ['class'=>'form-control','id'=>'en_career_status']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{ Form::text('responsible_civil_id', $family['responsible_civil_id'], ['class'=>'form-control','id'=>'responsible_civil_id']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{URL::to('upload/families/'.$family['image'])}}" class="img-thumbnail image_current">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                                    ...
                                    <tbody>
                                        @foreach($family['Reports'] as $report)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;"><a target="_blank" href="{{url('upload/families/'.$report['file'])}}" class="btn btn-sm btn-info">{{trans('admin.show')}}</a></td>
                                            <td style="vertical-align: middle;">
                                                <a href="{{url('admin/families_reports/'.$report['id'])}}" class="btn btn-sm btn-danger">{{trans('admin.delete')}}</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
