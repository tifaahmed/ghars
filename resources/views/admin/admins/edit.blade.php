                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::select('country_id',$countries, $admin['country_id'], ['class'=>'form-control select2','id'=>'country_id']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{ Form::text('whatsapp', $admin['whatsapp'], ['class'=>'form-control','id'=>'whatsapp']) }}
